...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 09 2022 г., 19:32
...
(20, 'Citron Card', 'Правильная дебетовая карта, которая зарабатывает деньги. Получайте кэшбэк и процент на остаток, снимайте наличные бесплатно. Действует ', 'img/cards/Preview-Cards/16679979801667807105Citron-Card.png', 3, 'Дебетовая');
...
(14, 'img/cards/On-Front/Glass-Card_Front-view-20.png', 12),
(15, 'img/cards/On-Front/Glass-Card_Front-view-20.png', 13),
(16, 'img/cards/On-Front/Glass-Card_Front-view-20.png', 12),
(19, 'img/cards/On-Front/Glass-Card_Front-view-18.png', 13),
(20, 'img/cards/On-Front/Glass-Card_Front-view-26.png', 13),
(21, 'img/cards/On-Front/Glass-Card_Front-view-25.png', 13),
(45, 'img/cards/On-Front/1667997980Glass-Card_Front-view-2.png', 20),
(46, 'img/cards/On-Front/1667997980Glass-Card_Front-view-17.png', 20),
(47, 'img/cards/On-Front/1667997980Glass-Card_Front-view-18.png', 20),
(48, 'img/cards/On-Front/1667997980Glass-Card_Front-view-19.png', 20),
(49, 'img/cards/On-Front/1667997980Glass-Card_Front-view-26.png', 20);
...
--
-- Структура таблицы `bank_feedback`
--

CREATE TABLE `bank_feedback` (
  `id_feedback` int NOT NULL,
  `email` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `bank_feedback`
--

INSERT INTO `bank_feedback` (`id_feedback`, `email`) VALUES
(5, 'elovdesign@mail.ru');
...
(11, 'Кирилл', 'Кириллов', 'Павлович', 'kirill@mail.ru', 'fcea920f7412b5da7be0cf42b8c93759', NULL, '+7(933)124-44-22', 'img/profile/default_profile_img.png', 'user', 'default'),
(12, 'Павел', 'Сержантов', 'Андреевич', 'newdesign@mail.ru', 'fcea920f7412b5da7be0cf42b8c93759', NULL, '+7(900)100-00-01', 'img/profile/default_profile_img.png', 'admin', 'banned'),
(21, 'Admin', 'Adminov', '', 'admin@mail.ru', 'f6fdffe48c908deb0f4c3bd36c032e72', NULL, '+7(000)000-00-00', 'img/profile/default_profile_img.png', 'user', 'default'),
(27, 'Test', 'Testov', 'Testovich', 'test@mail.ru', '05a671c66aefea124cc08b76ea6d30bb', NULL, '+7(111)111-11-11', 'img/profile/default_profile_img.png', 'user', 'default');
...
--
-- Индексы таблицы `bank_feedback`
--
ALTER TABLE `bank_feedback`
...
--
ALTER TABLE `bank_card_image-path`
  MODIFY `id_card_image-path` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
-- AUTO_INCREMENT для таблицы `bank_feedback`
--
ALTER TABLE `bank_feedback`
